...
<script>
	...
	$(document).ready(function(){
    		...
    		//SI SE HAN SELECCIONADO TODOS LOS PARÁMETROS.
		        ...
		        $('.tablaoculta').css("display","block");
		        	...
		        	for (var i = 0; i < array.length; i++) {
		        		...
		        		var url_borrar = "Equipo_Usuario/borrar_equipo_usuario_admin/"+array[i]['ID_Equipo_Alumno'];
		        		var url_editar = "Equipo_Usuario/editar_equipo_usuario_admin/"+array[i]['ID_Equipo_Alumno']+"/"+$("#select_modulo option:selected").val();
		...
		$("#botonAñadirNuevo").click(function(){
			...
			window.location.href = "Equipo_Usuario/nuevo_equipo_usuario_admin";
