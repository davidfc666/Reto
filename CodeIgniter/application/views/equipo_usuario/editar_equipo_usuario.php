	...
	<article class="tablaResponsive">
		...
		<?php
			...
			if ($usuarioEditar){
				...
				foreach ($usuarioEditar->result() as $usu) {
					echo "
					<tr>
						<th>Curso</th>
						<th>Centro</th>
	...
	$(document).ready(function(){
		...
		$("#select_curso").change(function(){
	        ...
	        data:{'ID_Curso':$("#select_curso").val(),
	        	  'ID_Centro':"<?php echo $usuarioEditar->result()[0]->ID_Centro; ?>"},
		...
		$("#botonMostrar").click(function(){
    		...
    		//SI SE HAN SELECCIONADO TODOS LOS PARÁMETROS.
		        ...
		        $('#tabla_equipos_usuarios').append($('<tr class="contenido"><td id="datosCurso">'+$("#select_curso option:selected").text()+'</td><td id="datosCentro">'+"<?php echo $usuarioEditar->result()[0]->DESC_Centro; ?>"+'</td><td id="datosCiclo">'+$("#select_ciclo option:selected").text()+'</td><td id="datosReto">'+$("#select_reto option:selected").text()+'</td><td id="datosEquipo">'+$("#select_equipo option:selected").text()+'</td><td id="datosTipoUsuario">'+"<?php echo $usuarioEditar->result()[0]->DESC_TUsuario; ?>"+'</td><td id="datosROl">'+$("#select_rol option:selected").text()+'</td><td id="datosUsuario">'+"<?php echo $usuarioEditar->result()[0]->User; ?>"+'</td><td>'+"<?php echo $usuarioEditar->result()[0]->Nombre; ?>"+'</td><td>'+"<?php echo $usuarioEditar->result()[0]->Apellidos; ?>"+'</td></tr>'));
		...
		$("#botonEditar").click(function(){
		    ...
		    $.post({url: "<?php echo base_url(); ?>index.php/Equipo_Usuario/guardar_cambios_equipo_usuario/<?php echo $usuarioEditar->result()[0]->ID_Equipo_Alumno; ?>",
		    datatype:"json",
