<h1 id="datosact">Añadir Equipo</h1>	
...
<script>
	...
	$(document).ready(function(){
		...
		$("#select_curso").change(function(){
			...
			//SE PONEN LAS TRAMPAS "CICLO" y "MODULO" A FALSE PARA QUE TENGAS QUE VOLVER A SELECCIONARLAS.
		 	trampaCiclo = false;
		    trampaModulo = false;
		...
		$("#botonVolver").click(function(){
    		...
    		window.location.href = "../Equipo/equipo_admin";
	    });
